//window.onload = function(){
    //this.onclick = function(){
        //var userResponse = this.data;  
       // var computerResponse = ; //генерация случайного числа
        //класс active выбронной кнопке
        //запуск анимации ожидания
        //показ правильного ответа 
        //табличка с интересным фактом
        //сравнение ответов 
        //изменение счете 
        //если счет = 20 то обьявляется победитель
window.onload = function() {
